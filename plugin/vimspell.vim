...
"      An empty list force vimspell to select dictionnaries installed for teh
...
"      Note that the hereafter described variables (the filetype dependant ones)
"      overrides, if exists, the spell_{language}_iskeyword variables. The
"      list must be empty or begin with a comma.
"      The following is defined: >
"	   let spell_francais_iskeyword  =  "39,½,æ,¼,Æ,-"
"<     which says that the quote, the hyphen and dome other digraphs must be
"      considered as being part of words (note the first comma).
"
"
...
"      latex *with aspell*. Vim need kill -9. -- To be reproduced (see also
"      Fabio Stumbo bug below)...
"    - BUG Accept without case doesn't work in german Latex mode.
